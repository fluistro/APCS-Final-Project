...
def generate_course_schedule():
    ...
    print ('2 a', len(schedule[0]))
    print ('2 b', len(schedule[1]))
    print ('2 c', len(schedule[2]))
    print ('2 d', len(schedule[3]))
