        ...
        if counter == 0:
            if section != 0:
                if course_info[course]['Outside Timetable'] == True:
                    pass
                elif 'IEP MODIFIED' in course_info[course]['course name']:
                    pass
                elif 'LEARNING STRATEGIES'in course_info[course]['course name']:
                    pass
                elif len(course_info[course]['Students']) == 0:
                    pass
                else:
