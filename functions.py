...
def generate_course_schedule():
    ...
    schedule = [
            ...
            # 1D 
            ["MCTWR11---", "MSPLG10--L","MPREC12---","MFMP-10---","MSC--09---","MSP--11---","MCMPS11---","APHM-12---","MENFP12---","MFOM-11---","MLST-12---","YLAW-2CX--","MPREC11---","MSC--10---","MATPH12---","MCMPS10C--","MADEM10---","MEN--09---","MPHE-09B--*MPHED10B--","MSS--09C--","MVAST10---*MAE--09---","MVAST11---*MVAST12---","MLFSC11---","MADFS09---*MFOOD10---","MSS--10---","MFR--10---","XLDCB09M--*MTPOW10---","MEVSC12C--","MPHE-09G--*MPHED10G--","MCLE-10---", "MCH--11---","MTEAR10---*MTROB11---*MTROB12---*MADER09---","MDRM-11---*MDRM-12---", "MWPM-11---", "MWWK-12---","YPSYC1AX--"],
