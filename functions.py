...
def generate_course_schedule():
    ...
    for block in range(len(schedule)):
        for course in schedule[block]:
            ...
            for c in courses:
                if c not in course_info:
                    print("weird block" + str(block) + " course: " + c)
    '''
